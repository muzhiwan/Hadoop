...
mysql -h10.1.1.2 -ustatsdkuser -pstatsdkuser2111579711 -D stat_sdk -e"ALTER TABLE  sdk_mobile_type_active_user_stat  ADD id INT( 10 ) NOT NULL AUTO_INCREMENT PRIMARY KEY   FIRST ;"
mysql -h10.1.1.2 -ustatsdkuser -pstatsdkuser2111579711 -D stat_sdk -e "ALTER TABLE  sdk_mobile_type_new_user_stat     ADD id INT( 10 ) NOT NULL AUTO_INCREMENT PRIMARY KEY   FIRST ;"
