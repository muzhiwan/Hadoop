...
sudo -u hdfs hive -e "
   ...
   drop table market_mobile_download_event_exchange;
    ...
    create table market_downlog_mob as 
          select a.day as day ,a.time as time,sum(a.click) as click,sum(a.begin) as begin ,sum(a.success) as success ,sum(a.error) as error ,sum(a.cancel) as cancel,sum(a.exchange) as exchange from market_mobile_download_event a group by a.day,a.time;    
