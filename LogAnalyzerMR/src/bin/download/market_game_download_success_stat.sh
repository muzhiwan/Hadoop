...
sudo -u hdfs hive -e "
 ...
 mysql -h10.1.1.16 -ustatsdkuser -pstatsdkuser2111579711 -D stat_sdk <<EOF
    ...
    DROP TABLE IF EXISTS market_game_download_success_stat;
    CREATE TABLE market_game_download_success_stat (
...
mysql -h10.1.1.16 -ustatsdkuser -pstatsdkuser2111579711 -D stat_sdk -e "ALTER TABLE  market_game_download_success_stat  ADD id INT( 10 ) NOT NULL AUTO_INCREMENT PRIMARY KEY   FIRST ;"
